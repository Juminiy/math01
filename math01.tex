...
\begin{displaymath}
    \oint_{\alpha}^{\beta} f(x(t),y(t)) \mathrm{d}s = \int_{a}^{b} f(x,y(x)) \sqrt{x'^2+y'^2} \mathrm{d}x = \int_{\alpha}^{\beta} f(r,\theta)\sqrt{r^2 + r'^2} \mathrm{d}\theta \quad t \in \alpha \to \beta \Rightarrow x \in a \to b
\end{displaymath}

\begin{displaymath}
    r = r(\theta), \theta = \alpha \to \beta , S = \frac{1}{2}\int_{\alpha}^{\beta}{r^2(\theta)}\mathrm{d}\theta
\end{displaymath}
...
\begin{align*}
    ...
    \frac{\partial f}{\partial l} |{(x_{0},y_{0},z_{0})} = f_{x}\cos \alpha + f_{y} \cos \beta + f_{z}\cos \gamma\\
    ...
    \bm{\mathrm{grad}}f(x_{0},y_{0}) = f_{x}(x_{0},y_{0})\bm{\vec{i}} + f_{y}(x_{0},y_{0})\bm{\vec{j}} \\ 
    S = \iint_{D_{xy}}\mathrm{d}S = \iint_{D_{xy}}\sqrt{1+(\frac{\partial z}{\partial x})^2+(\frac{\partial z}{\partial y})^2}\mathrm{d}\sigma \\ 
    \iint_{\Sigma}f \mathrm{d}S = \iint_{\Sigma_{1}}f\mathrm{d}S +  \iint_{\Sigma_{2}}f\mathrm{d}S \\ 
    ...
    \oint_{\Sigma}P\mathrm{d}y\mathrm{d}z+Q\mathrm{d}z\mathrm{d}x+R\mathrm{d}x\mathrm{d}y = \iiint_{\Omega} (\frac{\partial P}{\partial x}+{\frac{\partial Q}{\partial y}}+{\frac{\partial R}{\partial z}}) \mathrm{d}v \\ 
    \mathrm{div}\bm{\vec{A}} = \frac{\partial P}{\partial x}+{\frac{\partial Q}{\partial y}}+{\frac{\partial R}{\partial z}} \\
...
\begin{align*}
    \bm{Probability \quad Theory} \\ 
    A - B = A\bar{B} = A \cap \bar{B} \\ 
    f(x) = \frac{1}{\sqrt{2\pi}\sigma}\mathrm{e}^{-\frac{(x-\mu)^2}{2\sigma^2}} , x \in (-\infty,+\infty)  \\ 
    \Phi(x) = \int_{-\infty}^{x} f(t) \mathrm{d}t , X \sim N(0,1) \\ 
    \Phi(a)+\Phi(-a) = 1 \\ 
    ...
    \begin{array}{rl} 
        ...
        0, others
    \end{array} \right. \ \\ 
    f(x,y) = \frac{1}{2\pi \sigma_{1} \sigma_{2} \sqrt{1-\rho^2}} \mathrm{e}^{-\frac{1}{2(1-\rho^2)}[(\frac{x-\mu_{1}}{\sigma_{1}})^2-\frac{2\rho (x-\mu_{1})(y-\mu_{2})}{\sigma_{1}\sigma_{2}}+(\frac{x-\mu_{2}}{\sigma_{2}})^2]}
\end{align*}
...
\begin{align*}
    ...
    \sum_{i=0}^{n}{i^3} = (\sum_{i=0}^{n}{i})^2 = \frac{n^2(n+1)^2}{4} \\ 
